...
#def get_spectra_villaume(ID)
	

#	t = np.loadtxt('irtf/Unreddened/' + ID + '.txt')
	
#	return(t)

def set_spectra_name(Teff, logg, Z, ID):
	...
	sp_file = './Interpolated_Spectra/intspectra_' + ID + '_Teff' + temp_s[0] + '_logg' + temp_s[1]\
		+ '_Z' +temp_s[2]
